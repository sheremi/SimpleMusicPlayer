...
public class AlbumBrowserActivity extends ListActivity implements View.OnCreateContextMenuListener, MusicUtils.Defs,
    ...
    private void setTitle() {
        ...
        if (mAlbumCursor != null && mAlbumCursor.getCount() > 0) {
            ...
            fancyName = mAlbumCursor.getString(mAlbumCursor.getColumnIndex(AlbumColumns.ARTIST));
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        mCurrentAlbumId = mAlbumCursor.getString(mAlbumCursor.getColumnIndexOrThrow(BaseColumns._ID));
        mCurrentAlbumName = mAlbumCursor.getString(mAlbumCursor.getColumnIndexOrThrow(AlbumColumns.ALBUM));
        mCurrentArtistNameForAlbum = mAlbumCursor.getString(mAlbumCursor.getColumnIndexOrThrow(AlbumColumns.ARTIST));
    ...
    private Cursor getAlbumCursor(AsyncQueryHandler async, String filter) {
        String[] cols = new String[] { BaseColumns._ID, AlbumColumns.ARTIST, AlbumColumns.ALBUM, AlbumColumns.ALBUM_ART };
    ...
    static class AlbumListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        AlbumListAdapter(Context context, AlbumBrowserActivity currentactivity, int layout, Cursor cursor,
                String[] from, int[] to) {
