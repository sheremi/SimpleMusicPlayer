...
public class ArtistAlbumBrowserActivity extends ExpandableListActivity implements View.OnCreateContextMenuListener,
    ...
    private Cursor getArtistCursor(AsyncQueryHandler async, String filter) {
        ...
        String[] cols = new String[] { BaseColumns._ID, ArtistColumns.ARTIST, ArtistColumns.NUMBER_OF_ALBUMS,
        ...
        Cursor ret = null;
        if (async != null) {
            async.startQuery(0, null, uri, cols, null, null, ArtistColumns.ARTIST_KEY);
        } else {
            ret = MusicUtils.query(this, uri, cols, null, null, ArtistColumns.ARTIST_KEY);
        }
        return ret;
    }
    ...
    static class ArtistAlbumListAdapter extends SimpleCursorTreeAdapter implements SectionIndexer {
        ...
        ArtistAlbumListAdapter(Context context, ArtistAlbumBrowserActivity currentactivity, Cursor cursor, int glayout,
        ...
        public void bindChildView(View view, Context context, Cursor cursor, boolean islast) {
            ...
            String art = cursor.getString(cursor.getColumnIndexOrThrow(AlbumColumns.ALBUM_ART));
        ...
        protected Cursor getChildrenCursor(Cursor groupCursor) {
            ...
            String[] cols = new String[] { BaseColumns._ID, AlbumColumns.ALBUM, AlbumColumns.NUMBER_OF_SONGS,
                    AlbumColumns.NUMBER_OF_SONGS_FOR_ARTIST, AlbumColumns.ALBUM_ART };
            Cursor c = MusicUtils.query(mActivity, MediaStore.Audio.Artists.Albums.getContentUri("external", id), cols,
            ...
            class MyCursorWrapper extends CursorWrapper {
                ...
                public String getString(int columnIndex) {
                    if (columnIndex != mMagicColumnIdx) return super.getString(columnIndex);
                    return mArtistName;
                }

                @Override
                public int getColumnIndexOrThrow(String name) {
                    if (AlbumColumns.ARTIST.equals(name)) return mMagicColumnIdx;
                    return super.getColumnIndexOrThrow(name);
                }

                @Override
                public String getColumnName(int idx) {
                    if (idx != mMagicColumnIdx) return super.getColumnName(idx);
